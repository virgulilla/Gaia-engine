...
/// <summary>
/// Represents the deterministic simulation event emitted when a new world season begins.
/// </summary>
public sealed record NewSeasonSimulationEvent : TimeEventBase
{
    /// <summary>
    /// Initializes a new instance of the <see cref="NewSeasonSimulationEvent"/> class.
    /// </summary>
    ...
    public NewSeasonSimulationEvent(
        EventId eventId,
        long tick,
        long timestamp,
        int currentDay,
        ...
        int currentYear)
        : base(eventId, EventPriority.High, tick, timestamp, currentDay, currentSeason, currentYear)
    {
    }
}
